use nifty_core::{HistoryItem, Story, StorySummary, fetch_latest_stories, fetch_nifty_story};
use nifty_core::{AppState, Settings, load_state, save_state};
use crate::reader_ui::*;
use dioxus::prelude::*;
      ...
      main { class: "max-w-4xl mx-auto px-6 py-8",
        if *loading.read() {
          div { class: "flex flex-col items-center justify-center py-32 gap-6",
            ...
            p { class: "text-base-content/60 font-medium animate-pulse", "Preparing your story..." }
          }
